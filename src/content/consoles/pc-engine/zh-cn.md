...
hardware_variants:
  - name: "PC Engine CoreGrafx"
    release: "1989 JP"
    type: "修正版主机"
    note: "深灰机身、AV 输出改善、控制器微调。性能与初代 PC Engine 基本相同，但成为日本后期常见的标准本体。"
  - name: "PC Engine SuperGrafx"
    release: "1989 JP"
    type: "强化主机"
    note: "追加 VDC、更多 RAM，企图提前对抗 Mega Drive 与超任。硬件野心很大，但专属游戏只有 5 款，商业上很快退场。"
  - name: "PC Engine CD-ROM²"
    release: "1988 JP"
    type: "CD-ROM 扩展"
    slug: "pc-engine-cd-rom2"
    note: "家用主机最早量产 CD-ROM 游戏环境。靠 CD 音乐、语音、动画与大容量 RPG，让 PC Engine 形成第二条核心生态。"
  - name: "PC Engine Duo / Duo-R / Duo-RX"
    release: "1991-1994 JP"
    type: "HuCard + CD 一体机"
    note: "把 HuCard 与 CD-ROM² 整合成一台主机，省掉初代三件式组合。Duo-R/RX 是收藏圈常见的后期稳定型号。"
  - name: "TurboExpress / PC Engine GT"
    release: "1990 JP/NA"
    type: "掌机化版本"
    slug: "turbo-express"
    note: "完整执行 HuCard 的彩色掌机，概念接近把家用主机直接塞进手上。价格、电池与 LCD 良率让它停在核心玩家市场。"
---
