...
hardware_variants:
  - name: "PC Engine CoreGrafx"
    release: "1989 JP"
    type: "修正版主機"
    note: "深灰機身、AV 輸出改善、控制器微調。性能與初代 PC Engine 基本相同，但成為日本後期常見的標準本體。"
  - name: "PC Engine SuperGrafx"
    release: "1989 JP"
    type: "強化主機"
    note: "追加 VDC、更多 RAM，企圖提前對抗 Mega Drive 與超任。硬體野心很大，但專屬遊戲只有 5 款，商業上很快退場。"
  - name: "PC Engine CD-ROM²"
    release: "1988 JP"
    type: "CD-ROM 擴充"
    slug: "pc-engine-cd-rom2"
    note: "家用主機最早量產 CD-ROM 遊戲環境。靠 CD 音樂、語音、動畫與大容量 RPG，讓 PC Engine 形成第二條核心生態。"
  - name: "PC Engine Duo / Duo-R / Duo-RX"
    release: "1991-1994 JP"
    type: "HuCard + CD 一體機"
    note: "把 HuCard 與 CD-ROM² 整合成一台主機，省掉初代三件式組合。Duo-R/RX 是收藏圈常見的後期穩定型號。"
  - name: "TurboExpress / PC Engine GT"
    release: "1990 JP/NA"
    type: "掌機化版本"
    slug: "turbo-express"
    note: "完整執行 HuCard 的彩色掌機，概念接近把家用主機直接塞進手上。價格、電池與 LCD 良率讓它停在核心玩家市場。"
---
