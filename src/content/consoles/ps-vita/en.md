...
release:
  ...
  eu: "2012-02-22"
sales:
  official: "Never officially disclosed by Sony"
  community: "~15–16 million worldwide (Niko Partners estimate, 2019 discontinuation)"
  source: "Industry estimates; Sony internal numbers undisclosed"
specs:
  CPU: "Quad-core ARM Cortex-A9 @ 333 MHz–2 GHz (PowerVR SGX543MP4+ GPU)"
  Display: "**5-inch OLED touch** (Vita 1000) / **5-inch LCD** (Vita 2000 refresh) at 960×544"
  RAM: "512 MB system + 128 MB VRAM"
  Audio: "Stereo speakers + dual microphones"
  Media: "**Vita game cartridge + proprietary Memory Card** (notoriously expensive) + digital download"
  Network: "Wi-Fi 802.11b/g/n + 3G (some 1000 SKUs) + Bluetooth"
  Controls: "Dual analog sticks + front touchscreen + **rear touchpad** (a console first)"
images:
  hero:
    src: "/img/consoles/ps-vita-hero.jpg"
    alt: "PS Vita black OLED handheld with dual analog sticks and rear touchpad"
    caption: "PlayStation Vita PCH-1101, released in Japan December 2011 at ¥24,980. **A 5-inch OLED, two analog sticks, and a rear touchpad** — Sony's bid to put PS3-class graphics into a handheld. The proprietary Memory Card pricing and the maturing smartphone gaming market kept lifetime sales well below the PSP's."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "PS Vita PCH-1000 / 1100"
    release: "2011"
    type: "OLED launch flagship"
    note: "The launch Vita model, with a 5-inch OLED display, thicker shell, proprietary charging port, and optional 3G on some SKUs. Its OLED color made it the collector-preferred model later, and it best represents Sony's original premium-handheld ambition."
  - name: "PS Vita PCH-2000 Slim"
    release: "2013"
    type: "LCD slim revision"
    note: "Swapped OLED for LCD, made the body slimmer and lighter, improved battery life, and added 1 GB of built-in storage plus micro-USB charging. It improved portability and cost, but lost the OLED model's premium feel, showing Vita's shift from flagship to cost control."
  - name: "PlayStation TV / Vita TV"
    release: "2013 JP / 2014 WW"
    type: "Living-room microconsole"
    note: "A tiny HDMI box built from Vita hardware, able to play selected Vita, PSP, and PS1 digital games while supporting Remote Play. The idea was a micro PlayStation, but touch compatibility limits and unclear positioning pushed it out of the mainstream quickly."
  - name: "PS Vita Memory Card"
    release: "2011"
    type: "Expensive proprietary storage"
    note: "The proprietary 4 GB to 64 GB cards became Vita's most criticized hardware strategy. They were meant to fight piracy and control the ecosystem, but forced buyers into high extra storage costs and weakened the platform's entry appeal."
  - name: "PS Vita Game Card"
    release: "2011"
    type: "Proprietary physical cartridge"
    note: "Vita abandoned PSP's UMD and moved to small flash game cards, improving load times and battery behavior while moving closer to Nintendo handheld logic. But game-card storage and proprietary memory cards together failed to solve player frustration over total storage cost."
notable_games:
