...
release:
  ...
  eu: "1980-01-01"
sales:
  official: "~500,000 worldwide (1979–1981)"
  community: "**The first handheld with interchangeable cartridges** — a full decade before the Game Boy"
  source: "Milton Bradley 1981 exit cumulative"
specs:
  CPU: "**Embedded in each cartridge** (Intel 8021 or TMS1100, depending on title)"
  Display: "**16×16 monochrome LCD** — 256 total pixels"
  RAM: "Per-cartridge"
  Audio: "Simple beeps"
  Media: "ROM cartridge — **each cartridge contained its own CPU**"
  Battery: "9V battery for ~10 hours"
  Controls: "**12-key numeric keypad + rotary knob** (no D-pad)"
images:
  hero:
    src: "/img/consoles/microvision-hero.jpg"
    alt: "Milton Bradley Microvision black vertical handheld with small LCD"
    caption: "Milton Bradley Microvision, North American launch November 1979 at $49.95. **The first handheld with interchangeable cartridges** — a full decade ahead of the Game Boy. The 16×16 resolution (256 pixels — fewer than a modern emoji) put a hard ceiling on what kind of game could exist on it."
    license: PD
    author: "Evan-Amos"
