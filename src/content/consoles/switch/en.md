...
release:
  ...
  eu: "2017-03-03"
sales:
  official: "**146.65 million** (Nintendo cumulative through Q4 2024 — second-highest-selling Nintendo console of all time after the DS at 154M)"
  community: "Japan 35.4M / NA 50M / Europe & other 60M+"
  source: "Nintendo Q4 2024 earnings report"
specs:
  CPU: "NVIDIA Tegra X1 (custom, 4× Cortex-A57 + 4× A53)"
  GPU: "Maxwell 256 cores @ 307–768 MHz"
  RAM: "4 GB LPDDR4"
  Storage: "32 GB / 64 GB (OLED) internal + microSD external (up to 2 TB)"
  Resolution: "1080p docked / 720p handheld"
  Audio: "PCM + Dolby Atmos (added on the 2021 OLED model)"
  Media: "Game Card cartridge + digital download"
  Controller: "Joy-Con — detachable dual gamepads (HD Rumble + IR sensor)"
images:
  hero:
    src: "/img/consoles/switch-hero.jpg"
    alt: "Nintendo Switch in dock mode with red and blue Joy-Cons"
    caption: "Nintendo Switch (Red/Blue Joy-Con), worldwide simultaneous launch 3 March 2017 at ¥29,980. **Home console and handheld in one device** — undock and take it with you, dock it and play it on the TV. Nintendo's answer to the Wii U disaster was to redefine the hardware category itself."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Nintendo Switch HAC-001"
    ...
    note: "A 6.2-inch LCD, detachable Joy-Con, TV dock, and portable mode formed the purest version of the Switch concept. Early battery life was limited, but the hardware shape unified Nintendo's home-console and handheld businesses in one device."
  - name: "Nintendo Switch HAC-001(-01)"
    release: "2019"
    type: "Battery-life revision"
    note: "Externally almost unchanged, but using a more efficient Tegra X1 revision that noticeably improved handheld battery life. It was the most important internal revision after Switch moved from launch phenomenon to long-term mass-market platform."
  - name: "Nintendo Switch Lite"
    release: "2019"
    type: "Handheld-only entry model"
    note: "Removed TV output, fixed the controls in place, reduced screen size, and lowered price to $199. Lite pulled Switch back toward the Game Boy / DS handheld tradition and worked well as a second household system."
  - name: "Nintendo Switch OLED Model"
    release: "2021"
    type: "Premium handheld-experience model"
    note: "A 7-inch OLED screen, 64 GB internal storage, wide kickstand, improved speakers, and a dock with wired LAN improved handheld and tabletop play without increasing compute power. It extended Switch's life through display and industrial-design upgrades rather than a Pro spec bump."
  - name: "Joy-Con / Pro Controller / Ring-Con"
    release: "2017-2019"
    type: "Controller ecosystem"
    note: "Joy-Con splitting, motion controls, HD Rumble, and the IR sensor enabled nontraditional play in games like 1-2-Switch and Ring Fit Adventure; the Pro Controller covered long-session comfort. Switch's success came partly from accessories making one console become several play styles."
notable_games:
