...
release:
  ...
  jp: "2014-09-04"
sales:
  official: "Never officially disclosed (Microsoft stopped reporting in 2014)"
  community: "~58 million worldwide (industry estimate as of 2024 generation close)"
  source: "Industry NPD / Niko Partners estimates; Microsoft internal numbers undisclosed"
specs:
  CPU: "AMD Jaguar @ 1.75 GHz — 8-core x86-64"
  GPU: "AMD Radeon GCN @ 853 MHz — 1.31 TFLOPS"
  RAM: "8 GB DDR3 unified + 32 MB ESRAM"
  Storage: "500 GB / 1 TB / 2 TB SATA HDD (user-replaceable)"
  Resolution: "1080p baseline (native 4K on Xbox One X)"
  Audio: "Dolby Atmos / DTS:X / 7.1"
  Media: "Blu-ray Disc + digital download"
  Network: "Gigabit Ethernet + dual-band 802.11n"
images:
  hero:
    src: "/img/consoles/xbox-one-hero.jpg"
    alt: "Xbox One large black console (Brazil edition) with controller"
    caption: "Xbox One, North American launch 22 November 2013 at $499 (with mandatory Kinect 2.0 included). The E3 2013 reveal proposed an always-on Kinect, TV-first integration, **a 24-hour mandatory online check-in, and restrictions on used-game sharing** — a list that triggered an immediate community revolt. Microsoft walked back the worst of it within a week, but the market impression was already set."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Xbox One Launch Model"
    release: "2013"
    type: "Kinect-bundled black box"
    note: "The launch console was huge, used an external power brick, bundled Kinect 2.0, and cost $499. It positioned Xbox One as a living-room media hub, but forced Kinect, TV input, and DRM controversy made the hardware itself a symbol of Microsoft's strategic misread."
  - name: "Xbox One without Kinect"
    release: "2014"
    type: "Damage-control price cut SKU"
    note: "After Phil Spencer took over, Microsoft removed mandatory Kinect and released a $399 Kinect-free model, finally matching PS4's price tier. It was Xbox One's first major course correction and an implicit admission that the launch media-center strategy had failed."
  - name: "Xbox One S"
    release: "2016"
    type: "Slim 4K media revision"
    note: "Smaller chassis, internal power supply, Ultra HD Blu-ray, HDR, and 4K streaming, with a clean white design replacing the oversized black box. One S became the most balanced Xbox One model and a strong low-cost 4K Blu-ray player."
  - name: "Xbox One X"
    release: "2017"
    type: "Late-Gen 8 performance machine"
    note: "Codenamed Project Scorpio, it pushed 6 TFLOPS of GPU power and targeted native 4K with steadier frame rates, making it the most powerful console of its generation. It restored Xbox's hardware-engineering reputation, but arrived after PS4's market lead was effectively locked in."
  - name: "Xbox Elite Controller / Adaptive Controller"
    release: "2015 / 2018"
    type: "Pro and accessibility controllers"
    note: "The Elite Controller created a premium controller category with paddles, swappable sticks, and trigger stops; the Adaptive Controller brought accessibility hardware into the console mainstream. These were among the few Xbox One-era hardware ideas the industry continued to follow."
notable_games:
