...
release:
  ...
  eu: "2006-12-08"
sales:
  official: "101.63 million (Nintendo cumulative, 2021)"
  community: "Japan 12.75M / NA 41.54M / Europe & other 47.34M"
  source: "Nintendo cumulative shipments (pre-2021)"
specs:
  CPU: "IBM PowerPC \"Broadway\" @ 729 MHz (an uprated GameCube CPU)"
  GPU: "ATI \"Hollywood\" @ 243 MHz"
  RAM: "88 MB (24 MB 1T-SRAM + 64 MB GDDR3)"
  Resolution: "480p maximum — **deliberately no HD output**"
  Audio: "AI DSP — 32 channels"
  Media: "Wii Optical Disc (4.7 GB based on standard DVD)"
  Network: "Built-in 802.11 b/g Wi-Fi + Bluetooth (controllers)"
  Controller: "Wii Remote — IR pointer + 3-axis accelerometer (2006 home console revolution)"
images:
  hero:
    src: "/img/consoles/wii-hero.jpg"
    alt: "Wii white tower-style compact console with Wii Remote"
    caption: "Wii, released in Japan on 2 December 2006 at ¥25,000. Small enough to fit in any TV cabinet gap, **deliberately no HD output**, with a controller that introduced infrared pointing and accelerometer motion to mainstream consoles — Nintendo's answer to the spec war was simply to step out of it."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Wii RVL-001"
    release: "2006"
    type: "Launch model with GameCube compatibility"
    note: "The most complete Wii model, with GameCube controller ports, memory-card slots, and GC disc compatibility. It connected Wii's Blue Ocean outreach to Nintendo's existing player base and let early adopters carry the GameCube library forward."
    slug: "gamecube"
  - name: "Wii RVL-101"
    release: "2011"
    type: "No-GC horizontal revision"
    note: "Visually close to the original Wii, but with GameCube controller, memory-card, and disc compatibility removed, and marketed primarily for horizontal placement. It was the first clear sign of Wii becoming a cost-controlled family entry machine."
  - name: "Wii Mini RVL-201"
    release: "2012 CA / 2013 EU"
    type: "Budget long-tail model"
    note: "A red-and-black top-loading redesign that removed Wi-Fi, SD card support, and GameCube compatibility while dropping the price to $99. It reduced Wii almost to a disc-only toy and was a strange long-tail move alongside the Wii U launch."
  - name: "Wii MotionPlus / Wii Remote Plus"
    release: "2009 / 2010"
    type: "Precision motion upgrade"
    note: "MotionPlus added gyroscope tracking for more accurate swings, throws, and swordplay, later integrated into Wii Remote Plus. Wii Sports Resort and Skyward Sword both relied on it to fix the original Wii Remote's precision limits."
  - name: "Wii Balance Board"
    release: "2007"
    type: "Fitness and lifestyle peripheral"
    note: "Paired with Wii Fit, the Balance Board brought weight, center-of-gravity tracking, yoga, and training into the living room. It was the key hardware that pushed Wii into families, older users, rehabilitation spaces, and fitness culture."
notable_games:
