...
release:
  ...
  eu: "1997-03-01"
sales:
  official: "32.92 million (Nintendo, 2005)"
  community: "Japan 5.54M / North America 20.63M / Europe & other 6.75M"
  source: "Nintendo cumulative shipments, 2005"
specs:
  CPU: "NEC VR4300 @ 93.75 MHz (MIPS R4300i)"
  GPU: "SGI Reality Coprocessor — 100,000 polys/sec with z-buffer and trilinear filtering"
  RAM: "4 MB (expandable to 8 MB via Expansion Pak)"
  Resolution: "320×240 to 640×480"
  Audio: "16-bit ADPCM, synthesized in software on the RSP"
  Media: "ROM cartridge (4–64 MB)"
images:
  hero:
    src: "/img/consoles/n64-hero.jpg"
    alt: "Nintendo 64 console with three-grip controller"
    caption: "Nintendo 64, released 23 June 1996 at ¥25,000. The three-prong controller and the analog thumbstick (the first widely-deployed analog 3D control on a home console) became the system's visual and ergonomic signature."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  ...
  - name: "Pikachu N64 / Hello Mac N64 (Pokémon-themed editions)"
    release: "2000 JP/NA"
    type: "Pokémon-themed limited editions"
