...
sales:
  official: ""
  community: "Estimated under 100,000 units (1990-1994, primarily Taiwan / Hong Kong / OEM rebadges in Europe and North America)"
  source: "Bit Corporation 1990s advertising + Hardcore Computist collector interviews"
specs:
  CPU: "WDC 65SC02 @ 4 MHz (6502 derivative)"
  Display: "160 × 152 reflective LCD (monochrome, 4-level grayscale)"
  RAM: "4 KB"
...
curation:
  thesis: "Gamate is the Taiwanese answer to Game Boy that almost everyone forgets about. Bit Corporation released it in 1990 with one immediately recognizable feature: instead of GB-style chunky cartridges, Gamate ran on flat plastic cards roughly the size of a credit card. No other handheld in the era used that physical form factor — it is the cleanest visual signature of Taiwanese 1990s gray-hardware design."
  turning_point: "Launched in early 1990 in Taiwan at around NT$1,500 — less than half of what Game Boy retailed for locally (NT$3,000+). Distribution covered Zhonghua Market in Taipei, electronics stalls near major train stations, and night-market vendors. For Taiwanese kids born in the late 1980s, Gamate was often the first handheld they ever owned. But as with Watara Supervision, no major third party ever licensed for it. The ~70-game library was entirely Bit Corp and small Taiwanese/Hong Kong studios."
  local_memory: "In Taiwan, Gamate is remembered as 'the cheap GB-alternative on those small electronics stalls in Zhonghua Market.' Many 1990s-childhood Taiwanese players' first handheld was Gamate, not Game Boy. The card form factor also gave it a distinctive memory — kids stacked the plastic cards like playing cards in pencil cases instead of carrying around chunky cartridges."
curated_games:
  - title: "Brick Blast"
    reason: "Bit Corp's flagship Arkanoid clone. The most commonly recommended starting point on Gamate; the reflective LCD is just barely readable enough in sunlight to track ball and brick positions."
  - title: "Buster Bros"
    reason: "A Pang-style balloon shooter. Bit Corp's in-house port. Less polished than the arcade original, but proved Gamate's 4 MHz 65SC02 derivative could handle action scenes."
  - title: "Coin Boy (mahjong)"
    reason: "The most distinctly Chinese-flavoured release on the platform. A stripped-down mahjong title that Bit Corp positioned as a flagship for the Chinese-speaking market — clearly a deliberate localization strategy."
related_consoles:
  - slug: "game-boy"
    label: "Game Boy"
    note: "The actual opponent. GB's chunky carts vs Gamate's flat cards is the cleanest physical-form-factor comparison in early-1990s handhelds. GB won on third-party software; Gamate won on price and card design."
  - slug: "watara-supervision"
    label: "Watara Supervision"
    note: "The other GB competitor from the Chinese-speaking world. Watara was Hong Kong; Bit Corp was Taiwan. Two adjacent regions, two attempts at GB alternatives — Gamate used cards, Supervision used cartridges. Both lacked third parties; both vanished by 1996."
  - slug: "super-a-can"
    label: "Super A'Can (Funtech)"
    note: "Another Taiwanese homegrown gaming hardware effort, but on the home-console side. Funtech released Super A'Can in 1995, five years after Bit Corp launched Gamate. Both companies eventually folded, but both left evidence that Taiwan-original gaming hardware existed."
hardware_variants:
  - name: "Gamate (standard)"
    release: "1990"
    type: "8-bit card-based handheld"
    note: "The original. White chassis with reflective LCD on top, D-pad and AB buttons below. Card slot at the rear top of the unit."
  - name: "Gamate (revised)"
    release: "1992"
    type: "Cosmetic refresh"
    note: "Improved screen contrast, additional black and transparent shell colors. Internal hardware unchanged."
  - name: "Super Boy III (OEM rebrand)"
    release: "1991-1993"
    type: "European / North American rebrand"
    note: "Bit Corp licensed Gamate to European and North American distributors as 'Super Boy III' — physically identical to the original. The Super Boy III units circulating in European collector circles today are Gamates."
---
