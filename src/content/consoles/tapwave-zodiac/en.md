...
gen: h
kind: handheld
maker: Tapwave (founded by ex-Palm employees)
release:
  na: "2003-10-01"
sales:
  official: "~200,000 worldwide (2003–2005)"
  community: "**A Palm-OS-into-gaming attempt** — caught between Sony's PSP and Nintendo's DS the very next year"
  source: "Tapwave 2005 bankruptcy cumulative"
specs:
  CPU: "Motorola DragonBall MX1 ARM @ 200 MHz"
  Display: "**3.8-inch color TFT-LCD**, 480×320 (landscape)"
  RAM: "32 MB"
  Audio: "Yamaha YMU762"
  Media: "SD / MMC memory cards"
  OS: "**Palm OS 5 (Garnet)** — ran the entire Palm application catalog"
  Controls: "Dual analog + 4 buttons + touch"
images:
  hero:
    src: "/img/consoles/tapwave-zodiac-hero.jpg"
    alt: "Tapwave Zodiac black landscape handheld with color screen and dual analog sticks"
    caption: "Tapwave Zodiac, North American launch October 2003 at $299–399. **Founded by ex-Palm engineers** betting on a 'Palm OS handheld for games' category — but Sony's PSP and Nintendo's DS were both announced within months and shipped in 2004, taking the timing window with them."
    license: PD
    author: "Evan-Amos"
  ...
  gallery:
    - src: "/img/consoles/tapwave-zodiac-tapwave-zodiac2-and-stylus.jpg"
      ...
      alt: "Tapwave Zodiac 2 (128 MB premium SKU) with stylus"
      caption: "Tapwave Zodiac 2 (128 MB RAM, $399) shown with its stylus accessory — Palm OS 5's touch interface gave the Zodiac stylus input from day one, a year ahead of the Nintendo DS (2004)."
      license: PD
hardware_variants:
  - name: "Tapwave Zodiac 1 (32 MB, TWZ-1)"
    release: "2003 NA"
    type: "Original Palm OS handheld"
