...
release:
  ...
  na: "1990-08-22"
sales:
  official: "Never disclosed (SNK released no cumulative figure for the home AES)"
  community: "Estimated under one million worldwide; most owners were arcade enthusiasts"
  source: "Industry word-of-mouth estimates; SNK internal figures unpublished"
specs:
  CPU: "Motorola 68000 @ 12 MHz + Zilog Z80 @ 4 MHz"
  GPU: "SNK-designed LSPC family — 4,096 simultaneous colors out of 65,536"
  RAM: "64 KB (CPU) + 84 KB (VRAM)"
  Resolution: "320 × 224"
  Audio: "Yamaha YM2610 — 4-ch FM + 7-ch ADPCM"
  Media: "ROM cartridge (identical to MVS arcade carts, only the outer shell differs)"
images:
  hero:
    src: "/img/consoles/neo-geo-aes-hero.jpg"
    alt: "Neo Geo AES console with arcade-style joystick controller"
    caption: "Neo Geo Advanced Entertainment System, released 1990 at $649 USD launch (≈$1,500 in 2026 dollars). Cartridges retailed at $200–$300 each. Sold as a luxury product: **the arcade, intact, in your living room**."
    license: CC-BY-SA-3.0
    author: "Evan-Amos"
    source_url: "https://commons.wikimedia.org/wiki/File:Neo-Geo-AES-Console-Set.jpg"
hardware_variants:
  - name: "Neo Geo AES (standard home unit)"
    release: "1990 JP / NA"
    type: "Original luxury home console"
    note: "Launched in Japan on April 26, 1990 at ¥58,000, then in North America that August at $649. **The first home console in history to ship the arcade board verbatim into the living room** — AES and the MVS arcade board shared identical hardware, with only the plastic shell separating them. Early distribution ran primarily through Neo Geo World rental stores (a console plus a few cartridges for a week). It wasn't a mass-market product but a status purchase."
  - name: "Neo Geo MVS (Multi-Video System arcade board)"
    release: "1990-2004"
    type: "Arcade-bound sister platform"
    note: "MVS — the four-slot (sometimes one- to six-slot) commercial arcade board — was the form Neo Geo actually reached the public in. It was the standard fit-out for Taiwanese arcades, Hong Kong's Mong Kok parlors, and Shenzhen's Dongmen game centers throughout the 1990s. **For nearly all Asian Chinese-speaking gamers, the Neo Geo experience was MVS, not AES.** Identical software ran identically on both — MVS carts simply cost less without the AES plastic shell."
  - name: "Neo Geo CD / Neo Geo CDZ"
    release: "1994 JP / 1995 NA"
    type: "Optical-disc cost-down line"
    note: "Released September 1994, the Neo Geo CD (¥49,800) replaced ROM cartridges with CD media, dropping the console price to mainstream-console levels in a bid to break out of the luxury niche. But **load times were brutal** (KOF '95 took over 30 seconds), and CDs couldn't match the late-era 330-Mbit Neo Geo carts in capacity. The 1995 Neo Geo CDZ (Japan only) added a faster drive, but by then the PS1 / Saturn 32-bit wave had swept the market away."
  - name: "Neo Geo X Gold (Tommo licensee unit)"
    release: "2012"
    type: "Reissue handheld with arcade dock"
