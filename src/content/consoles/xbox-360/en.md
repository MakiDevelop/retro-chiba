...
release:
  ...
  eu: "2005-12-02"
sales:
  official: "Never officially disclosed (Microsoft stopped quarterly figures after 2014)"
  community: "~84 million worldwide (industry consensus at 2016 discontinuation)"
  source: "Microsoft last disclosed 84M in 2014; light revisions post-discontinuation"
specs:
  CPU: "IBM Xenon @ 3.2 GHz — three PowerPC cores, two threads each"
  GPU: "ATI Xenos @ 500 MHz — first commercial unified shader GPU"
  RAM: "512 MB GDDR3 unified"
  Storage: "20 / 60 / 120 / 250 / 320 GB HDD (removable / internal)"
  Resolution: "480p to 1080p"
  Audio: "7.1 Dolby Digital / DTS"
  Media: "DVD-DL (up to 8.5 GB); HD-DVD via add-on drive (2006–08)"
  Network: "100 Mbps Ethernet built-in; Wi-Fi via external adapter (early SKUs)"
images:
  hero:
    src: "/img/consoles/xbox-360-hero.jpg"
    alt: "Xbox 360 Pro white tower-style console with wireless controller"
    caption: "Xbox 360 Pro, North American launch 22 November 2005 at $399. A full year ahead of the PS3, with the **first commercial unified-shader GPU** and a wireless controller that became the new standard. Early SKUs also produced the **Red Ring of Death** — a hardware-fault rate that exceeded 30% and triggered an $1.15 billion warranty provision."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Xbox 360 Core / Arcade"
    release: "2005 / 2007"
    type: "Entry model without hard drive"
    note: "The Core model launched without a hard drive; Arcade later substituted memory cards or small internal storage at a lower price. These SKUs showed Microsoft's attempt to lower the entry price, but Xbox Live, downloads, and installs quickly proved that a hard drive was the correct 360 experience."
  - name: "Xbox 360 Pro / Premium"
    release: "2005"
    type: "Mainstream 20GB / 60GB model"
    note: "The main launch SKU bundled a hard drive, wireless controller, and component cables, making it the white 360 most players remember. It is also the hardware generation most associated with RROD risk, leaving 360's success permanently shadowed by failure rates."
  - name: "Xbox 360 Elite"
    release: "2007"
    type: "Black HDMI premium model"
    note: "Added HDMI, a 120 GB hard drive, and a black shell, positioning it above Pro. Elite moved 360 deeper into HD living-room media and downloadable-content habits, making storage capacity a visible competitive feature."
  - name: "Xbox 360 S"
    release: "2010"
    type: "Slim thermal redesign"
    note: "Smaller chassis, built-in Wi-Fi, touch buttons, a Kinect port, and redesigned cooling largely solved early RROD problems. It became the stable mid-to-late-life 360 hardware and gave Microsoft the foundation to push Kinect into the mass market."
  - name: "Xbox 360 E / HD DVD / Kinect"
    release: "2006-2013"
    type: "Late hardware and accessory pivots"
    note: "The E model adopted styling closer to Xbox One as a cost-reduced late revision; the external HD DVD drive vanished after Blu-ray won the format war. Kinect exploded first on 360, but its success also planted the mistake of bundling it by force with Xbox One."
notable_games:
  - "Halo 3 (Bungie, 2007)"
