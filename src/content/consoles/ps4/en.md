...
release:
  ...
  jp: "2014-02-22"
sales:
  official: "117.5 million (Sony SIE PS 30th-anniversary disclosure, 2024)"
  community: "The third PlayStation to cross 100M (after PS2 160M and PS1 102.4M)"
  source: "Sony Interactive Entertainment 2024 disclosure"
specs:
  CPU: "AMD Jaguar @ 1.6 GHz — 8-core x86-64 (first home console on PC architecture)"
  GPU: "AMD Radeon GCN @ 800 MHz — 1.84 TFLOPS"
  RAM: "8 GB GDDR5 unified (256-bit bus)"
  Storage: "500 GB / 1 TB / 2 TB SATA HDD (user-replaceable)"
  Resolution: "1080p standard (4K via checkerboard on PS4 Pro)"
  Audio: "True Audio + 7.1 LPCM / Dolby"
  Media: "Blu-ray Disc + digital download"
  Network: "Gigabit Ethernet + 802.11n / 802.11ac (later SKUs)"
images:
  hero:
    src: "/img/consoles/ps4-hero.jpg"
    alt: "PS4 FAT black parallelogram console with DualShock 4 controller"
    caption: "PlayStation 4 CUH-1001A, North American launch 15 November 2013 at $399. The 'For the players' campaign was a precision counter to the Xbox One's forced Kinect, forced online check-in, and $499 launch — same generation, $100 less, no compulsory accessory, no always-online — and PS4 cleared 1 million units on its first day."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "PS4 CUH-1000 / 1100"
    release: "2013"
    type: "Launch angled chassis"
    note: "The original black parallelogram PS4, with a 500 GB hard drive and capacitive power/eject buttons. Early units are remembered for fan noise and occasional eject-button quirks, but they established the winning $399, no-Kinect, no-forced-online launch narrative."
  - name: "PS4 CUH-1200"
    release: "2015"
    type: "Stability revision"
    note: "Visually close to the launch model, but with physical buttons, lower power draw, lower noise, and a revised internal board and power supply. It marked PS4's transition from launch momentum to mature mass production."
  - name: "PS4 Slim CUH-2000"
    release: "2016"
    type: "Mainstream slim model"
    note: "Smaller, cooler, cheaper at $299, and updated with HDR support. The Slim became the standard PS4 of the second half of the generation and the primary model for households and expanding markets."
  - name: "PS4 Pro CUH-7000"
    release: "2016"
    type: "Mid-generation performance upgrade"
    note: "Raised GPU power to 4.2 TFLOPS, added checkerboard 4K, HDR, and more stable frame rates. It was one of the first home consoles to split a generation into standard and high-performance tiers, paving the way for later PS5 and Xbox Series performance segmentation."
  - name: "DualShock 4 / PlayStation VR"
    release: "2013 / 2016"
    type: "Controller and VR ecosystem"
    note: "DualShock 4 added a touchpad, light bar, share button, and headset jack, making social sharing and VR tracking part of the default hardware language. PS VR brought VR into the console market and became the most successful mass-market VR platform of its generation despite limited resolution."
notable_games:
