...
release:
  ...
  eu: "1995-07-08"
sales:
  official: "Sega never disclosed a precise lifetime figure"
  community: "~9.26M worldwide (community consensus): Japan 5.8M / NA 1.8M / Europe & other 1.65M"
  source: "Famitsu, industry reports, and post-discontinuation estimates"
specs:
  CPU: "Dual Hitachi SH-2 @ 28.6 MHz (parallel multiprocessor)"
  GPU: "VDP1 (sprite/polygon) + VDP2 (background scrollers) — dual graphics chips"
  RAM: "2 MB main + 1.5 MB VRAM + 540 KB audio"
  Resolution: "352×240 to 704×448"
  Audio: "Yamaha SCSP — 32-channel PCM/FM"
  Media: "CD-ROM (up to 660 MB)"
images:
  hero:
    src: "/img/consoles/saturn-hero.jpg"
    alt: "Sega Saturn Japanese Mk1 console with controller"
    caption: "Sega Saturn (Japanese Mk1), released 22 November 1994 at ¥44,800 — eleven days before the PlayStation. The dual-SH-2 / dual-VDP architecture made 2D output exceptional and made the platform notoriously hostile to developers."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Saturn Model 1 (HST-3200 / MK-80000)"
    ...
    type: "Original oval-button model"
