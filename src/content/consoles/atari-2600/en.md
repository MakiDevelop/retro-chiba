...
gen: 2
kind: home
maker: Atari, Inc. (Warner Communications subsidiary)
release:
  na: "1977-09-11"
  eu: "1980-09-01"
  jp: "1983-10-01"
sales:
  official: "~30 million worldwide (including the late 2600 Jr.)"
  community: "Produced 1977–1992, **one of the longest-produced home consoles ever** (15 years)"
  source: "Atari cumulative figure at 1992 discontinuation"
specs:
  CPU: "MOS Technology 6507 @ 1.19 MHz"
  TIA: "Atari custom — Television Interface Adapter (display, audio, and I/O combined)"
  RAM: "**128 bytes** (no zeros missing — one hundred and twenty-eight bytes)"
  Resolution: "160 × 192 (NTSC)"
  Palette: "128 simultaneous colors"
  Audio: "TIA two-channel square wave"
  Media: "ROM cartridge (4 KB standard; later titles used bank-switching up to 32 KB)"
images:
  hero:
    src: "/img/consoles/atari-2600-hero.jpg"
    alt: "Atari 2600 wood-grain four-switch console with joystick"
    caption: "Atari 2600 'Wood Grain' 4-Switch model (1980–82), original release 1977. **128 bytes of RAM started the entire 8-bit era** — *Pitfall!* fitting 256 rooms into 4 KB of cartridge code remains a touchstone of constraint engineering."
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Atari VCS CX2600 Heavy Sixer"
    release: "1977"
    type: "First-run six-switch woodgrain model"
    note: "The Sunnyvale-made Heavy Sixer was the earliest VCS model, with a heavy shell, six front switches, and a woodgrain face that made it look more like living-room hi-fi equipment than a toy. Atari was still selling video games as premium home electronics."
  - name: "Atari VCS Light Sixer / 4-Switch Woody"
    release: "1978-1980"
    type: "Cost-reduced mass-market models"
    note: "The Light Sixer and later four-switch woodgrain model lowered manufacturing cost and became the look most associated with the 2600 boom. For many American players, Atari meant this woodgrain box and a black joystick."
  - name: "Atari 2600 Vader"
    release: "1982"
    type: "All-black redesign"
    note: "The Vader model dropped the woodgrain for an all-black shell, marking Atari's shift from 1970s living-room appliance styling toward 1980s electronic-toy design. It arrived during the Pac-Man and E.T. crisis, making it a visual marker of the downturn."
  - name: "Atari 2600 Jr."
    release: "1986"
    type: "Low-cost long-tail redesign"
    note: "The 2600 Jr. kept the 1977 architecture alive after the NES had rebuilt the market. Sold cheaply into the early 1990s, it proved the 2600 was not only an early console, but a platform that spanned almost the whole 8-bit era."
  - name: "Sears Video Arcade / Coleco Gemini"
    release: "1977-1983"
    type: "Retail-label system and compatible clone"
    note: "Sears' Video Arcade label and Coleco's Gemini compatible machine show how the 2600 cartridge standard became a de facto platform. The same openness helped create the uncontrolled software flood that fed the 1983 crash."
notable_games:
