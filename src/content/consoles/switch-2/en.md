...
release:
  ...
  eu: "2025-06-05"
sales:
  official: "3.5M units in the first four days (Nintendo June 2025 disclosure — **the fastest-selling home console launch ever recorded**)"
  community: "Estimated to have crossed 10M cumulative within four months (industry estimate, Q4 2025)"
  source: "Nintendo Q2 2025 earnings report"
specs:
  CPU: "Custom NVIDIA T239 (Ampere architecture) — ARM Cortex-A78C, 8 cores"
  GPU: "NVIDIA Ampere, 1536 cores — DLSS support and hardware ray tracing"
  RAM: "12 GB LPDDR5X (3× the original Switch)"
  Storage: "256 GB UFS internal + microSD Express (a console first; up to 2 TB)"
  Resolution: "Docked 4K @ 60 Hz / Handheld 1080p @ 120 Hz"
  Audio: "PCM + Dolby Atmos + 3D surround"
  Screen: "7.9-inch LCD (HDR10)"
  Media: "Game Card cartridge + digital download"
  Controller: "Joy-Con 2 — magnetic attachment + mouse mode (the controller halves slide on a desk surface like a mouse)"
images:
  hero:
    src: "/img/consoles/switch-2-hero.jpg"
    alt: "Nintendo Switch 2 in dock mode with Joy-Con 2 controllers"
    caption: "Nintendo Switch 2, worldwide simultaneous launch 5 June 2025, ¥49,980 / ~$449. **The four-day launch sales of 3.5 million units set a new record for the fastest-selling home console ever** — more than triple the original Switch's same-window pace."
...
hardware_variants:
  - name: "Nintendo Switch 2 System"
    release: "2025"
    type: "Launch hybrid console"
    note: "A 7.9-inch LCD, magnetic Joy-Con 2, 256 GB internal storage, 4K docked output, and Switch 1 backwards compatibility made this Nintendo's first direct same-brand successor. Its job was not to reinvent the idea, but to upgrade Switch into a long-term platform."
  - name: "Nintendo Switch 2 + Mario Kart World Bundle"
    release: "2025"
    type: "Launch bundle"
    note: "Bundling Mario Kart World extended Nintendo's tradition of using Mario Kart to drive family and multiplayer adoption. The bundle pulled the Switch 2 story away from specifications and back toward playing together."
  - name: "Joy-Con 2"
    release: "2025"
    type: "Magnetic and mouse-mode controller"
    note: "Joy-Con 2 uses magnetic attachment, adds a surface-sliding mouse mode, and includes controls tied to GameChat. It preserves the split-controller multiplayer idea while trying to bring FPS, strategy, and creation-style inputs into a console controller."
  - name: "Nintendo Switch 2 Pro Controller"
    release: "2025"
    type: "Long-session controller"
    note: "The Pro Controller continues the traditional gamepad role, covering long sessions, action games, and competitive play where Joy-Con grip is not ideal. For core players, it is the Switch 2's closest point to the PS / Xbox controller experience."
  - name: "Nintendo Switch 2 Camera / microSD Express"
    release: "2025"
    type: "GameChat and high-speed storage accessories"
    note: "The Switch 2 Camera supports GameChat video and in-game camera features; microSD Express supports higher-capacity, faster storage. Together they show Switch 2 upgrading not only graphics, but online social play and large-game data streaming."
notable_games:
