...
release:
  ...
  eu: "2002-03-14"
sales:
  official: "Microsoft has never disclosed an official lifetime figure"
  community: "~24 million worldwide (IDC estimate + industry consensus)"
  source: "Wikipedia citing IDC; Microsoft internal numbers unpublished"
specs:
  CPU: "Intel Pentium III \"Coppermine-128\" @ 733 MHz"
  GPU: "NVIDIA NV2A @ 233 MHz (DirectX 8 derivative)"
  RAM: "64 MB DDR unified"
  Storage: "**Built-in 8 GB hard drive** (a console first)"
  Resolution: "640×480 to 1080i"
  Audio: "MCPX + 256-channel 3D"
  Media: "DVD-ROM"
  Network: "10/100 Ethernet built in (Xbox Live launched 2002)"
images:
  hero:
    src: "/img/consoles/xbox-hero.jpg"
    alt: "Microsoft Xbox black console (large) with Duke controller"
    caption: "Microsoft Xbox, North American launch 15 November 2001 at $299. The largest home console of its time (the Duke controller was equally outsized; the slimmer S controller followed). But also the **first home console with a built-in hard drive and Ethernet networking.**"
    license: PD
    author: "Evan-Amos"
...
hardware_variants:
  - name: "Xbox Launch Console"
    release: "2001"
    type: "Original oversized black console"
    note: "The black X-shaped shell, huge chassis, internal hard drive, and built-in Ethernet were Microsoft's statement that PC architecture had entered the living room. It was not elegant like a Japanese console; it traded size, cooling, and storage for developer familiarity and online-service infrastructure."
  - name: "Duke Controller"
    release: "2001"
    type: "Launch large controller"
    note: "The Duke was famously oversized, with a crowded face-button layout, and became a punchline for players with normal-sized hands. It reflected early Xbox's very American, hardcore product language and directly led to Controller S becoming the standard."
  - name: "Controller S"
    release: "2002"
    type: "Standardized smaller controller"
    note: "Originally designed for Japan, it was smaller, easier to grip, and eventually replaced the Duke worldwide. It established the long-running Xbox controller language: dual analog sticks, triggers, and offset stick placement."
  - name: "Xbox Live Starter Kit"
    release: "2002"
    type: "Online-service entry kit"
    note: "Bundled one year of Xbox Live, a headset, and setup disc, making voice chat, friends lists, unified accounts, and matchmaking part of the console experience. More than a hardware revision, it created Xbox's platform core for the next two decades."
  - name: "Special Edition / Debug Kits"
    release: "2002-2005"
    type: "Crystal shells and developer hardware"
    note: "The original Xbox had translucent green, translucent black, Crystal, and other regional limited editions, plus developer debug kits. These matter to collectors because the console's shell language was so strong that transparent plastic immediately reads as early-2000s tech culture."
notable_games:
